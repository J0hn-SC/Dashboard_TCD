...
# Save to CSV files
quarterly_data.to_csv('data5/quarterly_cases.csv', index=False)
weekly_data.to_csv('data5/weekly_cases.csv', index=False)
...
summary_stats.to_csv('data5/summary_stats.csv', index=False)